...
# Visa Information Chatbot (LangGraph, LangChain, LLMs) 
(File: Visa_Chatbot_Notebook.ipynb)
...
# QA Chatbot for Any Topic (RAG-based LLM Application) 
(File: FAQ_Chatbot_For_Any_Topic.ipynb)
...
# Clinical Note Summarizer (LLM Fine-Tuning, NLP) 
(File: NLP_Transformers_Clinical_Note_Summarizer_Via_Gen_AI_(tiny_llama).ipynb)
...
# Consumer Complaint Classifier (NLP, Machine Learning) 
(File: Consumer_Complaint_Classifier.ipynb)
...
# NVIDIA Stock Price Forecasting (Time Series, LSTM) 
(File: NVIDIA_Stock_Market_Forecast.ipynb)
...
# Pneumonia Classification from Chest X-Rays (Computer Vision, Transfer Learning) 
(File: Computer_Vision_Image_Classification_(Non_Transformer).ipynb)
...
# Airline Ticket Price Prediction (Tabular Regression, GPU Acceleration) 
(File: Airline_Ticket_Price_Prediction.ipynb)
